...
echo '{
  ...
  "DeviceLoginScreenAutoclickEnabled": not set,
  "DeviceLoginScreenCaretHighlightEnabled": not set,
  "DeviceLoginScreenCursorHighlightEnabled": not set,
  "DeviceLoginScreenDefaultLargeCursorEnabled": not set,
  "DeviceLoginScreenDefaultScreenMagnifierType": not set,
  "DeviceLoginScreenDefaultSpokenFeedbackEnabled": not set,
  "DeviceLoginScreenDefaultVirtualKeyboardEnabled": not set,
  "DeviceLoginScreenHighContrastEnabled": not set,
  "DeviceLoginScreenKeyboardFocusHighlightEnabled": not set,
  "DeviceLoginScreenMonoAudioEnabled": not set,
  "DeviceLoginScreenScreenMagnifierType": null,
  "DeviceLoginScreenSelectToSpeakEnabled": not set,
  "DeviceLoginScreenShowOptionsInSystemTrayMenu": true,
  "DeviceLoginScreenSpokenFeedbackEnabled": not set,
  "DeviceLoginScreenStickyKeysEnabled": not set,
  "DeviceLoginScreenVirtualKeyboardEnabled": not set,
  "DictationEnabled": not set,
  ...
  "KeyboardFocusHighlightEnabled": not set,
  "LargeCursorEnabled": not set,
  "MonoAudioEnabled": true,
  "ScreenMagnifierType": null,
  "SelectToSpeakEnabled": null,
  "SpokenFeedbackEnabled": true,
  "StickyKeysEnabled": not set,
  "UiAutomationProviderEnabled": true,
